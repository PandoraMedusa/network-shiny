...
#use the external r files to build the ui.R and serve.R
source("chooser.R")
source("functions.R")
...
# Create custom test which can be editted in layout
...
# Main program for ui.R display
shinyUI(fluidPage(
    titlePanel("network app"),
    splitLayout( 
      wellPanel(width=12,
        
        # Tab Bar for tabset Panel
        tabsetPanel(
          tabPanel('Data',
            fluidRow(
              column(12,
